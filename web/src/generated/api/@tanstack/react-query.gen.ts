...
export const threadTakeoverPreviewQueryKey = (options: Options<ThreadTakeoverPreviewData>) => createQueryKey('threadTakeoverPreview', options);

/**
 * Preview the local Codex writer and conversations affected by force takeover
 */
export const threadTakeoverPreviewOptions = (options: Options<ThreadTakeoverPreviewData>) => queryOptions<ThreadTakeoverPreviewResponse, ThreadTakeoverPreviewError, ThreadTakeoverPreviewResponse, ReturnType<typeof threadTakeoverPreviewQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await threadTakeoverPreview({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: threadTakeoverPreviewQueryKey(options)
});

/**
 * Stop the confirmed external Codex writer and resume the original conversation
 */
export const threadTakeoverTakeoverMutation = (options?: Partial<Options<ThreadTakeoverTakeoverData>>): UseMutationOptions<ThreadTakeoverTakeoverResponse, ThreadTakeoverTakeoverError, Options<ThreadTakeoverTakeoverData>> => {
    const mutationOptions: UseMutationOptions<ThreadTakeoverTakeoverResponse, ThreadTakeoverTakeoverError, Options<ThreadTakeoverTakeoverData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await threadTakeoverTakeover({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
