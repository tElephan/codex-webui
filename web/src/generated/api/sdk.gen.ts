 ...
 */
export const threadTakeoverPreview = <ThrowOnError extends boolean = false>(options: Options<ThreadTakeoverPreviewData, ThrowOnError>) => (options.client ?? client).get<ThreadTakeoverPreviewResponses, ThreadTakeoverPreviewErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const threadTakeoverTakeover = <ThrowOnError extends boolean = false>(options: Options<ThreadTakeoverTakeoverData, ThrowOnError>) => (options.client ?? client).post<ThreadTakeoverTakeoverResponses, ThreadTakeoverTakeoverErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/threads/{threadId}/takeover',
    ...options,
    headers: {
